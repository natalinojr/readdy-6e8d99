...
- **Pegadinha em aberto:** DARF de IRRF da folha (código 0561) sozinho cai como "Impostos" na DRE (o `lerGuia` só trata como encargo da folha os códigos previdenciários) — o IRRF já está no bruto da folha, então contaria duas vezes. Corrigir em `_shared/guias.ts` exige republicar brain/webhook/app juntos.
