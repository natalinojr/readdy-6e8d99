...
const MODULOS: ModuloCard[] = [
  ...
  },
  {
    id: 'tarefas',
    titulo: 'Tarefas',
    descricao: 'Gestão de tarefas da equipe: listas, checklists e prazos',
    icon: 'ri-task-line',
    rota: '/tarefas',
    acento: '#6366f1',
    acentoText: 'text-indigo-600',
  ...
  },
  {
    ...
    descricao: 'Emissão de NFS-e pelo Emissor Nacional, sem custo por nota',
    icon: 'ri-file-text-line',
    rota: '/notas-servico',
    acento: '#0284c7',
    acentoText: 'text-sky-600',
    acentoBg: 'bg-sky-50',
    acentoBorder: 'border-sky-200/70',
    tag: 'Admin',
    modulo: 'nfse',
  },
  {
    id: 'assistente',
    titulo: 'Assistente',
    descricao: 'Seu assistente pessoal no WhatsApp',
