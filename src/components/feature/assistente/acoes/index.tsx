...
export const ACOES: AcaoDef[] = [
  ...
  { id: 'pedir-reembolso', grupo: 'Financeiro', label: 'Pedir reembolso', icone: 'ri-refund-2-line', cor: 'bg-emerald-50 text-emerald-600', Componente: lazy(() => import('./financeiro/PedirReembolso')) },
  { id: 'aprovar-pedidos', grupo: 'Financeiro', label: 'Aprovar pedidos de pagamento', icone: 'ri-checkbox-multiple-line', cor: 'bg-emerald-50 text-emerald-600', Componente: lazy(() => import('./financeiro/AprovarPedidos')) },
  { id: 'cmv-mes', grupo: 'Financeiro', label: 'CMV do mês', icone: 'ri-pie-chart-2-line', cor: 'bg-emerald-50 text-emerald-600', Componente: lazy(() => import('./financeiro/CmvMes')) },
  ...
  { id: 'publicar-cardapio', grupo: 'Operação', label: 'Publicar cardápio', icone: 'ri-restaurant-line', cor: 'bg-orange-50 text-orange-600', Componente: lazy(() => import('./operacao/PublicarCardapio')) },
  { id: 'atualizar-aparelhos', grupo: 'Operação', label: 'Atualizar os aparelhos', icone: 'ri-refresh-line', cor: 'bg-orange-50 text-orange-600', Componente: lazy(() => import('./sistema/AtualizarAparelhos')) },
  ...
  { id: 'ifood-pedido', grupo: 'iFood', label: 'Pedido do iFood pelo número', icone: 'ri-file-list-3-line', cor: 'bg-red-50 text-red-600', Componente: lazy(() => import('./ifood/PedidoIfood')) },
  { id: 'ifood-cancelamentos', grupo: 'iFood', label: 'Cancelamentos do iFood', icone: 'ri-close-circle-line', cor: 'bg-red-50 text-red-600', Componente: lazy(() => import('./ifood/CancelamentosIfood')) },
  { id: 'ifood-tempos', grupo: 'iFood', label: 'Tempos do iFood', icone: 'ri-timer-line', cor: 'bg-red-50 text-red-600', Componente: lazy(() => import('./ifood/TemposIfood')) },
  { id: 'ifood-repasse-caiu', grupo: 'iFood', label: 'O repasse caiu?', icone: 'ri-bank-line', cor: 'bg-red-50 text-red-600', Componente: lazy(() => import('./ifood/RepasseCaiu')) },
  ...
  { id: 'clientes-sumidos', grupo: 'Clientes e marketing', label: 'Clientes que sumiram', icone: 'ri-user-unfollow-line', cor: 'bg-pink-50 text-pink-600', Componente: lazy(() => import('./marketing/ClientesSumidos')) },
