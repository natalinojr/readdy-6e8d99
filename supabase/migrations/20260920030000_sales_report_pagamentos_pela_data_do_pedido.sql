-- Relatório de vendas: "Por forma de pagamento" somava pelos pagamentos do DIA (p.created_at) enquanto
-- o faturamento soma pelos pedidos do dia (o.created_at). Pedido de sábado pago 00:08 de domingo
-- entrava no faturamento e sumia dos pagamentos (dono, 2026-09-20: R$ 845,30 de faturamento com
-- R$ 749,30 em formas de pagamento). As duas contas passam a usar a data do PEDIDO.
