...
- set_count_inventory: ingredient_id, count_inventory (boolean). false = o insumo sai da contagem de inventário (tela e contagem rápida) e a confirmação do inventário o ignora; compra, entrada, saída, ficha técnica e CMV seguem normais. upsert_ingredient também aceita count_inventory.
