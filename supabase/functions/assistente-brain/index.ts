...
TOOLS.push({
  ...
  input_schema: {
    ...
    properties: {
      ...
      chave_pix: { type: 'string', description: 'Pix: chave (CNPJ, CPF, e-mail, telefone +55 ou aleatória). Só vai para fornecedor cadastrado ou para a lista de Pix permitidos, ambos cadastrados pelo Natalino na tela; você não cadastra nada disso.' },
